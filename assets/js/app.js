...
import { initCrypto } from './crypto.js?v=43';
import { loadConfig, getApp, getUsers, getSession, login, logout } from './auth.js?v=43';
import { h, clear, toast, initials, brandStrip } from './ui/components.js?v=43';
import { renderLogin } from './ui/login.js?v=43';
import { renderMatches, renderHistory } from './ui/matches.js?v=43';
import { renderTable } from './ui/table.js?v=43';
import { renderRules } from './ui/rules.js?v=43';
import { maybeOnboard } from './ui/onboarding.js?v=43';
import { setupPullToRefresh } from './ui/pull-refresh.js?v=43';
import { setupDrawerSwipe } from './ui/drawer-swipe.js?v=43';
...
function buildShell() {
  const sidebar = h('aside', { class: 'sidebar', id: 'sidebar' }, [
    h('a', { class: 'brand', href: '#matches', 'aria-label': 'На главную', onclick: (e) => { e.preventDefault(); navigate('matches'); } }, [
      h('img', { class: 'brand-logo', src: 'assets/img/logo.png?v=43', alt: 'ЛВС', width: 52, height: 52 }),
