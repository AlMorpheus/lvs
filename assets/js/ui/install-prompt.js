...
import { h } from './components.js?v=58';
import { isIOS, isStandalone } from '../push.js?v=58';
...
function showOverlay(ios) {
  ...
  const card = h('div', { class: 'a2hs-card' }, [
    ...
    h('img', { class: 'a2hs-logo', src: 'assets/img/logo.png?v=58', alt: 'ЛВС', width: 64, height: 64 }),
