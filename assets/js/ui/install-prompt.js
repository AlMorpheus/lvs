...
import { h } from './components.js?v=60';
import { isIOS, isStandalone } from '../push.js?v=60';
...
function showOverlay(ios) {
  ...
  const card = h('div', { class: 'a2hs-card' }, [
    ...
    h('img', { class: 'a2hs-logo', src: 'assets/img/logo.png?v=60', alt: 'ЛВС', width: 64, height: 64 }),
